...
_repo-html:
	echo '<html><head><title>nfqws2-keenetic repository</title></head><body>' > out/_pages/$(BUILD_DIR)/index.html
...
_repo-index:
	echo '<html><head><title>nfqws2-keenetic repository</title></head><body>' > out/_pages/index.html
...
_repository:
	...
	echo "Package: nfqws2-keenetic" > out/_pages/$(BUILD_DIR)/Packages
	echo "Version: $(VERSION)" >> out/_pages/$(BUILD_DIR)/Packages
	echo "Depends: iptables, busybox" >> out/_pages/$(BUILD_DIR)/Packages
	echo "Conflicts: tpws-keenetic, nfqws-keenetic" >> out/_pages/$(BUILD_DIR)/Packages
